...
Эта статья предназначена для backend-разработчиков, ищущих работу на hh.ru. Если вы действительно компетентный специалист, то сможете разобраться с этим спартанским(неудобным) интерфейсом. Высокий порог входа – не следствие моей лени, а намеренное решение.
...
Код проекта доступен на GitHub: [ссылка на репозиторий]
